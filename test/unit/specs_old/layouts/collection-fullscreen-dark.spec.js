...
import CollectionFullscreenDark from '@/layouts/collection-fullscreen-dark'
import { routes } from '@/test/fixtures/routes'

describe('Collection fullscreen dark layout', () => {
  let localVue = null
  let wrapper = null
  let router = null
  let store = null
  ...
  beforeEach(() => {
    ...
    wrapper = mount(CollectionFullscreenDark, {
      localVue,
      store,
      router
    })
